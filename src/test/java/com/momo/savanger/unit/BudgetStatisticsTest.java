...
//        assertNotNull(stats);
//        assertEquals(BigDecimal.ZERO, stats.getEarningsAmount());
//        assertEquals(BigDecimal.valueOf(2), stats.getExpensesAmount());
//        assertEquals(BigDecimal.ZERO, stats.getDebtLendedAmount());
//        assertEquals(BigDecimal.ZERO, stats.getDebtReceivedAmount());
//
...
//
//        assertNotNull(stats);
//        assertEquals(BigDecimal.valueOf(1), stats.getEarningsAmount());
//        assertEquals(BigDecimal.valueOf(2), stats.getExpensesAmount());
//        assertEquals(BigDecimal.ZERO, stats.getDebtLendedAmount());
//        assertEquals(BigDecimal.ZERO, stats.getDebtReceivedAmount());
...
//        Long budgetId = 1L;
//
//        when(transactionService.getEarningsAmount(budgetId, true)).thenReturn(BigDecimal.valueOf(1000));
//        when(transactionService.getExpensesAmount(budgetId, true)).thenReturn(BigDecimal.valueOf(200));
//        when(transactionService.getExpensesAmount(budgetId, false)).thenReturn(BigDecimal.valueOf(2));
//        when(transactionService.getDebtLendedAmount(budgetId)).thenReturn(BigDecimal.ZERO);
//        when(transactionService.getDebtReceivedAmount(budgetId)).thenReturn(BigDecimal.ZERO);
//        when(prepaymentService.getRemainingPrepaymentAmountSumByBudgetId(budgetId)).thenReturn(
//                BigDecimal.ZERO);
...
//
//        when(transactionService.getEarningsAmount(budgetId, true)).thenReturn(BigDecimal.valueOf(1000));
//        when(transactionService.getEarningsAmount(budgetId, false)).thenReturn(BigDecimal.valueOf(1));
//        when(transactionService.getExpensesAmount(budgetId, true)).thenReturn(BigDecimal.valueOf(200));
//        when(transactionService.getExpensesAmount(budgetId, false)).thenReturn(BigDecimal.valueOf(2));
//        when(transactionService.getDebtLendedAmount(budgetId)).thenReturn(BigDecimal.ZERO);
//        when(transactionService.getDebtReceivedAmount(budgetId)).thenReturn(BigDecimal.ZERO);
